...
export const UploadIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
...
export const AlertIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
...
export const CheckCircleIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
...
export const RefreshIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
...
export const MonitorIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
...
export const GlobeIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
...
export const CpuIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
...
export const TerminalIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><polyline points="4 17 10 11 4 5" /><line x1="12" y1="19" x2="20" y2="19" /></svg>
);
export const WindowsIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}><path d="M0 3.449L9.75 2.1v9.451H0m10.949-9.602L24 0v11.4H10.949M0 12.6h9.75v9.451L0 20.699M10.949 12.6H24V24l-12.9-1.801" /></svg>
);
export const AppleIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z" /></svg>
);
export const LinuxIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}><path d="M12.504 0c-.155 0-.315.008-.48.021-4.226.333-3.105 4.807-3.17 6.298-.076 1.092-.3 1.953-1.05 3.02-.885 1.051-2.127 2.75-2.716 4.521-.278.832-.41 1.684-.287 2.489a.424.424 0 00-.11.135c-.26.268-.45.6-.663.839-.199.199-.485.267-.797.4-.313.136-.658.269-.864.68-.09.189-.136.394-.132.602 0 .199.027.4.055.536.058.399.116.728.04.97-.249.68-.28 1.145-.106 1.484.174.334.535.47.94.601.81.2 1.91.135 2.774.6.926.466 1.866.67 2.616.47.526-.116.97-.464 1.208-.946.587-.003 1.23-.269 2.26-.334.699-.058 1.574.267 2.577.2.025.134.063.198.114.333l.003.003c.391.778 1.113 1.368 1.884 1.43.868.07 1.723-.26 2.456-.594.733-.34 1.336-.644 1.649-.203.167.236.602.69 1.27.89.668.2 1.326-.195 1.64-.752.311-.544.108-1.03.054-1.467-.073-.466-.14-.855-.06-1.146.18-.418.186-.91.04-1.274-.105-.267-.278-.48-.464-.645.075-.203.146-.334.107-.51-.04-.422-.282-.726-.547-1.025-.267-.298-.527-.519-.475-.903.05-.356-.154-.668-.346-.91a3.01 3.01 0 00-.345-.39c-.137-.131-.27-.263-.395-.455-.833-1.285-2.058-2.577-2.747-4.2-.238-.559-.39-1.262-.467-2.072-.076-.81-.1-1.725-.088-2.678.006-.466-.04-.882-.137-1.266-.1-.383-.26-.726-.474-1.03-.432-.607-1.058-1.02-1.76-1.287C13.882.153 13.186.015 12.504 0z" /></svg>
);
export const CalendarIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
...
export const TrashIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
...
export const CrosshairIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
...
export const CopyIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
...
export const ActivityIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
...
export const WifiIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M5 12.55a11 11 0 0 1 14.08 0" /><path d="M1.42 9a16 16 0 0 1 21.16 0" /><path d="M8.53 16.11a6 6 0 0 1 6.95 0" /><line x1="12" y1="20" x2="12.01" y2="20" /></svg>
);
...
export const GitCompareIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><circle cx="18" cy="18" r="3" /><circle cx="6" cy="6" r="3" /><path d="M13 6h3a2 2 0 0 1 2 2v7" /><path d="M11 18H8a2 2 0 0 1-2-2V9" /></svg>
);
export const MapPinIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
...
export const VolumeIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
...
export const VolumeMuteIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
...
export const ArrowRightIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
...
export const MinusIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
...
export const PlusIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = '' }) => (
...
export interface AnalysisResult {
  scan_id: string | null;
  analysis: {
    totalProcesses: number; criticalProcesses: number; suspiciousProcesses: number;
    warningProcesses: number; safeProcesses: number; unknownProcesses: number;
    totalConnections: number; criticalConnections: number; suspiciousConnections: number;
    totalStartupItems: number; criticalStartup: number; suspiciousStartup: number;
    totalScheduledTasks: number; totalServices: number; suspiciousTempFiles: number;
  };
  threats: ThreatItem[];
  threatScore: number;
  threatLevel: string;
  ...
  networkConnections: ConnectionItem[];
  startupItems: StartupItem[];
  scanDuration: number;
}

export interface ThreatItem {
  type: string; severity: string; detail: string; source: string;
  processName?: string; pid?: number; remoteAddress?: string; remotePort?: number; itemName?: string;
}

export interface ProcessItem {
  name: string; pid: number; path: string; memoryMB: number; cpu: number;
  user: string; isKnown: boolean; riskScore: number;
  findings: Array<{ type: string; severity: string; detail: string }>; status: string;
}

export interface ConnectionItem {
  localAddress: string; localPort: number; remoteAddress: string; remotePort: number;
  state: string; protocol: string; processName: string; pid: number;
  riskScore: number; findings: Array<{ type: string; severity: string; detail: string }>; status: string;
}

export interface StartupItem {
  name: string; command: string; location: string; user: string; enabled: boolean;
  riskScore: number; findings: Array<{ type: string; severity: string; detail: string }>; status: string;
}

export interface ScanHistoryItem {
  id: string; scan_type: string; os_info: any; threat_score: number; threat_level: string;
  status: string; scan_duration_ms: number; created_at: string; completed_at: string; analysis_result: any; source?: string;
}

export interface ScanSchedule {
  id: string; user_id: string; hostname: string; platform: string; frequency: string;
  enabled: boolean; last_scan_at: string | null; next_scan_at: string | null;
  install_token: string; created_at: string; updated_at: string;
}

// ─── Utilities ───
export const getThreatColor = (level: string) => {
  switch (level) {
    case 'critical': return { text: 'text-red-400', bg: 'bg-red-500/10', border: 'border-red-500/30', glow: 'shadow-[0_0_15px_rgba(255,0,0,0.3)]' };
    case 'high': return { text: 'text-orange-400', bg: 'bg-orange-500/10', border: 'border-orange-500/30', glow: 'shadow-[0_0_15px_rgba(255,153,0,0.3)]' };
    case 'medium': return { text: 'text-yellow-400', bg: 'bg-yellow-500/10', border: 'border-yellow-500/30', glow: '' };
    case 'low': return { text: 'text-blue-400', bg: 'bg-blue-500/10', border: 'border-blue-500/30', glow: '' };
    case 'safe': return { text: 'text-green-400', bg: 'bg-green-500/10', border: 'border-green-500/30', glow: '' };
    default: return { text: 'text-gray-400', bg: 'bg-gray-500/10', border: 'border-gray-500/30', glow: '' };
  }
};
...
export const threatScoreColor = (score: number) => score >= 75 ? '#ef4444' : score >= 50 ? '#f97316' : score >= 25 ? '#eab308' : score >= 10 ? '#3b82f6' : '#22c55e';
